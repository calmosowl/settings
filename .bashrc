...
function __prompt_command_generator() {
	...
	local TXTRED='\[\e[00;31m\]'       # red
	local TXTGRN='\[\e[00;32m\]'       # green
	local TXTYLW='\[\e[00;33m\]'       # yellow
	local TXTBLU='\[\e[00;34m\]'       # blue
	local TXTPUR='\[\e[00;35m\]'       # purple
	local TXTCYN='\[\e[00;36m\]'       # cyan
	local TXTWHT='\[\e[00;37m\]'       # white
	local BLDRED='\[\e[01;31m\]'       # red    - Bold
	local BLDGRN='\[\e[01;32m\]'       # green
	local BLDYLW='\[\e[01;33m\]'       # yellow
	local BLDBLU='\[\e[01;34m\]'       # blue
	local BLDPUR='\[\e[01;35m\]'       # purple
	local BLDCYN='\[\e[01;36m\]'       # cyan
	local BLDWHT='\[\e[01;37m\]'       # white
	local TXTRST='\[\e[00m\]'          # Text reset
...
alias bravis='adb connect 192.168.15.221:5555 && adb shell'
